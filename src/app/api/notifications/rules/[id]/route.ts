...
export async function PATCH(
  ...
  try {
    ...
    const finalRecipientType =
      validatedData.recipientType || existingRule.recipientType;
    const finalRecipientUserId =
      validatedData.recipientUserId !== undefined
        ? validatedData.recipientUserId
        : existingRule.recipientUserId;
    const finalRecipientRoleId =
      validatedData.recipientRoleId !== undefined
    ...
    if (validatedData.trigger !== undefined)
      updateData.trigger = validatedData.trigger;
    if (validatedData.daysOffset !== undefined)
      updateData.daysOffset = validatedData.daysOffset;
    ...
    if (validatedData.recipientUserId !== undefined)
      updateData.recipientUserId = validatedData.recipientUserId;
    if (validatedData.recipientRoleId !== undefined)
      updateData.recipientRoleId = validatedData.recipientRoleId;
