        ...
        <DialogContent className="max-w-lg max-h-[85vh] flex flex-col">
          ...
          <div className="space-y-4 py-4 overflow-y-auto flex-1">
            ...
            <div className="space-y-3">
              ...
              {Object.entries(accessGroups).map(([resource, resourceAccesses]) => (
                <div key={resource} className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={() => toggleResourceGroup(resourceAccesses)}
                      disabled={isSaving}
                    />
                    <Label
          ...
          <DialogFooter>
            <Button variant="ghost" onClick={handleCloseRoleDialog} disabled={isSaving}>
              Cancel
            </Button>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={userRoleId} onValueChange={setUserRoleId} disabled={isSaving}>
                <SelectTrigger>
          ...
          <DialogFooter>
            <Button variant="ghost" onClick={handleCloseUserDialog} disabled={isSaving}>
              Cancel
            </Button>
            <Button onClick={handleSaveUser} disabled={isSaving}>
              {isSaving ? "Saving..." : editingUser ? "Update User" : "Invite User"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <AlertDialog open={isDeleteUserDialogOpen} onOpenChange={setIsDeleteUserDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove &quot;{deletingUser?.name}&quot; from your organization? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          {deleteError && (
            <div className="rounded-md bg-destructive/15 p-3 text-sm text-destructive">
